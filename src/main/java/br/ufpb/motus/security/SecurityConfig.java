...
public class SecurityConfig {
    ...
    public SecurityConfig(
            ...
            @Value("${motus.security.cors.allowed-origins:http://localhost:3000,http://localhost:5173}") String allowedOrigins) {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, LoginRateLimiterFilter loginRateLimiterFilter) throws Exception {
        return http
    ...
    /**
     * Prevents the servlet container from also auto-registering the rate limiter;
     * it is only invoked through the Spring Security filter chain above.
     */
    @Bean
    public FilterRegistrationBean<LoginRateLimiterFilter> loginRateLimiterRegistration(LoginRateLimiterFilter filter) {
